...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="animate-slide-top mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-foreground sm:text-7xl">
      ...
      <p className="animate-slide-top delay-200 mx-auto mt-6 max-w-2xl text-lg tracking-tight text-secondary-foreground">
